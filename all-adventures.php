    ...
    <body>
        <nav class="navbar twitter-mode" role="navigation">
            ...
            <ul class="navbar__links">
                ...
                <li class="navbar__link second"><a href="#">Book Trip</a></li>
                <li class="navbar__link third"><a href="#">Admin Login</a></li-->
            </ul>
            <button class="burger">
                <span class="bar"></span>
            </button>
        ...
        <main class="main_content" role="main">
            <h1>Come Expirente Canada</h1>
        </main>

        <div class="title_up_main">
            <section class="title_up">
                <h1 class="title-first">Upcomming Adventures</h1>
            </section>
        </div>
        <?php
        ...
        <div class="section-main">
                    <div class="section-first">
                        ...
                        Date : <?php echo $row['tripdate'];?><br/>
                        Duration : <?php echo $row['duration'];?> days<br/><br/>
                        <h3>Summary</h3>
                        <p>
                        <?php echo $row{'summary'};?><br/><br/><br/>
                        </p>
                    </div>
                <?php }?>
          ...
          <footer>
            <div class="content-footer">
              ...
              <div class="bloc footer-contact">
                <h3>Stay in touch</h3>
                <p>506-XXX-XXXX</p>
                <p>blondeloua@outlook.com</p>
                <p>53 Vail Street, Moncton, NB</p>
              </div>
        ...
        <script type="text/javascript" scr="https://code.jquery.com/jquery-3.4.1.slim.min.js"></script>
